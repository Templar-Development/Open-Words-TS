...
const LatinAddons: any = {
  ...
  prefixes: [
    { pos: "X", form: "X X", senses: ["- away, off; - aside;"], orth: "abs" },
    { pos: "V", form: "V V", senses: ["- away, off; - aside;"], orth: "ab" },
    {
      pos: "X",
      form: "X X",
      senses: ["- to, towards, near, for, together (adeo => go to);"],
      orth: "ac c"
    },
    {
      pos: "X",
    ...
    },
    {
      pos: "X",
      form: "X X",
      senses: ["having to do with buildings/temples;"],
      orth: "aedi"
    },
    { pos: "X", form: "X X", senses: ["equi-, equal;"], orth: "aequi" },
    {
      pos: "X",
      form: "X X",
      senses: ["- to, towards, near, for, together (adeo => go to);"],
    ...
    { pos: "X", form: "X X", senses: ["high, lofty;"], orth: "alti" },
    {
      pos: "X",
      form: "X X",
      senses: ["around, round about; having two;"],
      orth: "ambi"
    },
    {
      pos: "X",
    ...
    { pos: "X", form: "X X", senses: ["ante-, - before;"], orth: "ante" },
    {
      pos: "X",
      form: "X X",
      senses: [
    ...
    },
    {
      pos: "X",
      form: "X X",
      senses: ["arch-, chief-, first, master; great; extremely, very;"],
      orth: "archi"
    },
    {
      pos: "X",
    ...
    },
    {
      pos: "X",
      form: "X X",
      senses: ["golden, gold-; of gold, gold-colored;"],
      orth: "auri"
    },
    {
      pos: "X",
      form: "X X",
      senses: ["- away, off (aufero => make off with, carry away); - aside;"],
      orth: "au f"
    },
    { pos: "V", form: "V V", senses: ["- away, off; - aside;"], orth: "a" },
    { pos: "V", form: "V V", senses: ["well, good"], orth: "bene" },
    { pos: "V", form: "V V", senses: ["well, good;"], orth: "beni" },
    {
      pos: "X",
      form: "X X",
      senses: ["two, twice; double; having two;"],
      orth: "bis"
    },
    {
      pos: "X",
    ...
    },
    {
      pos: "X",
      form: "X X",
      senses: ["sweet-, soothing-, smooth-, charming, flattering;"],
      orth: "blandi"
    },
    {
      pos: "X",
      form: "X X",
      senses: ["cardio-, pertaining to the heart;"],
      orth: "cardio"
    },
    {
      pos: "X",
      form: "X X",
      senses: ["hundred (numerical prefix);"],
      orth: "centi"
    },
    {
      pos: "X",
    ...
    },
    {
      pos: "X",
      form: "X X",
      senses: ["- around, about, near;"],
      orth: "circum"
    },
    {
      pos: "X",
      form: "X X",
      senses: ["- together, completely, forcibly, strongly;"],
      orth: "col  l"
    },
    {
      pos: "X",
    ...
    { pos: "X", form: "X X", senses: ["- against;"], orth: "contra" },
    {
      pos: "X",
      form: "X X",
      senses: ["- together; completely, strongly, forcibly, violently;"],
      orth: "con"
    },
    {
      pos: "X",
    ...
    { pos: "X", form: "X X", senses: ["two (numerical prefix);"], orth: "du" },
    {
      pos: "V",
      form: "V V",
      senses: ["- out, away from; beyond; completely;"],
      orth: "ef f"
    },
    {
      pos: "X",
      form: "X X",
      senses: ["electro-; electrical; electronic;"],
      orth: "electro"
    },
    { pos: "V", form: "V V", senses: ["- outside;"], orth: "extra" },
    {
      pos: "V",
      form: "V V",
      senses: ["- out, away from; beyond; completely;"],
    ...
    { pos: "X", form: "X X", senses: ["umequal;"], orth: "inaequi" },
    {
      pos: "V",
      form: "V V",
      senses: ["between, within; at intervals, to pieces;"],
      orth: "inter"
    },
    {
      pos: "N",
    ...
    },
    {
      pos: "V",
      form: "V V",
      senses: ["within, inside; - between, at intervals, to pieces;"],
      orth: "intra"
    },
    {
      pos: "V",
    ...
    { pos: "A", form: "ADJ ADJ", senses: ["not -, un-, -less;"], orth: "in" },
    {
      pos: "V",
      form: "V V",
      senses: ["- in, - on, - against; not -, un-;"],
    ...
    { pos: "V", form: "V V", senses: ["ill, bad;"], orth: "male" },
    { pos: "N", form: "N N", senses: ["much, many;"], orth: "multi" },
    { pos: "A", form: "ADV ADV", senses: ["not;"], orth: "ne" },
    { pos: "V", form: "V V", senses: ["not;"], orth: "non" },
    {
      pos: "V",
      form: "V V",
      senses: ["- towards, to meet, in opposition;"],
      orth: "ob"
    },
    {
      pos: "X",
      form: "X X",
      senses: ["eight (numerical prefix);"],
      orth: "octu"
    },
    {
      pos: "V",
    ...
    },
    {
      pos: "A",
      form: "ADJ ADJ",
      senses: ["very -, - completely, - thoroughly;"],
      orth: "per"
    },
    {
      pos: "V",
    ...
    { pos: "V", form: "V V", senses: ["- forward;"], orth: "por" },
    {
      pos: "X",
      form: "X X",
      senses: ["past or by; (drive past, drive by, flow past, flow by);"],
      orth: "praeter"
    },
    {
      pos: "X",
    ...
    { pos: "V", form: "V V", senses: ["- back, - again;"], orth: "red" },
    { pos: "X", form: "X X", senses: ["- back, - again;"], orth: "re" },
    {
      pos: "V",
      form: "V V",
      senses: ["- apart, apart from; away;"],
      orth: "sed"
    },
    { pos: "X", form: "X X", senses: ["semi-, half, partly;"], orth: "semi" },
    {
      pos: "X",
      form: "X X",
      senses: ["seven (numerical prefix);"],
      orth: "septem"
    },
    {
      pos: "X",
    ...
    { pos: "X", form: "X X", senses: ["six-;"], orth: "ses" },
    {
      pos: "X",
      form: "X X",
      senses: ["six (numerical prefix);"],
      orth: "sexti"
    },
    {
      pos: "X",
    ...
    },
    {
      pos: "X",
      form: "X X",
      senses: ["one (numerical prefix), single, simple;"],
      orth: "sim"
    },
    {
      pos: "V",
      form: "V V",
      senses: ["sub-; - up to, - under, up from under; to the aid;"],
      orth: "sub"
    },
    {
      pos: "N",
    ...
    },
    {
      pos: "V",
      form: "V V",
      senses: ["- up to, - under, up from under; to the aid;"],
      orth: "suc  c"
    },
    {
      pos: "N",
    ...
    },
    {
      pos: "X",
      form: "X X",
      senses: ["super-, over, above, upon; from above; over and above;"],
      orth: "super"
    },
    {
      pos: "X",
    ...
    { pos: "V", form: "V V", senses: ["super-, over, above;"], orth: "sur" },
    {
      pos: "V",
      form: "V V",
      senses: ["- up to, - under, up from under; to the aid;"],
    ...
    { pos: "V", form: "V V", senses: ["- across, - over;"], orth: "trans" },
    { pos: "V", form: "V V", senses: ["- across, - over;"], orth: "tra" },
    { pos: "V", form: "V V", senses: ["- across, - over;"], orth: "tre i" },
    {
      pos: "X",
      form: "X X",
      senses: [
    ...
    },
    {
      pos: "N",
      form: "N N",
      senses: ["beyond; exceeding; over; more than;"],
      orth: "ultra"
    },
    {
      pos: "A",
      form: "ADJ ADJ",
      senses: ["extremely; more; overly; more than;"],
      orth: "ultra"
    },
    {
      pos: "N",
    ...
    },
    {
      pos: "A",
      form: "ADJ ADJ",
      senses: ["one-; having (only/but) one ~; (being) of one ~;"],
      orth: "uni"
    },
    {
      pos: "A",
    ...
    },
    {
      pos: "N",
      form: "N N",
      senses: ["five-; fifth; (Roman numeral for 5);"],
      orth: "V"
    },
    {
      pos: "N",
      form: "N N",
      senses: ["ten-; tenth; (Roman numeral for 10);"],
      orth: "X"
    }
  ],
  ...
  suffixes: [
    ...
    {
      pos: "X",
      form: "X 2 ADJ 3 1 POS 2",
      orth: "ac",
      senses: ["-ing; having a tendency;"]
    },
    {
      pos: "N",
      form: "N 2 ADJ 1 1 POS 0",
    ...
    },
    {
      ...
      form: "V 2 V 3 1 X  1",
      orth: "sc",
      senses: ["begin to -, grow - (Inceptive or Inchoative);"]
    },
    {
      pos: "V",
      form: "V 2 V 3 1 X  2",
    ...
    },
    {
      ...
      form: "V 2 ADJ 1 1 POS 0",
      orth: "cund",
      senses: ["-ent; -ful; -ing; characteristic of; capacity or inclination;"]
    },
    {
      pos: "V",
      form: "V 2 ADJ 1 1 POS 0",
      orth: "id",
      senses: ["-ous; tending to, in a condition of, in a state of;"]
    },
    {
      pos: "A",
      form: "ADJ 2 ADV SUPER 0",
      orth: "issime",
      senses: ["-estily; -estly; most -ly, much -ly, very -ly;"]
    },
    {
      pos: "N",
      form: "N 2 ADJ 1 1 POS 0",
    ...
    },
    {
      ...
      form: "N 2 ADV POS 1",
      orth: "ose",
      senses: ["-fully, -ily, -ly; -tiously;"]
    },
    {
      pos: "A",
      form: "ADJ 4 ADV SUPER 0",
      orth: "me",
      senses: ["-estily; -estly; most -ly, much -ly, very -ly;"]
    },
    { pos: "N", form: "N 2 ADJ 1 1 POS 0", orth: "e", senses: ["make of;"] },
    { pos: "A", form: "ADJ 2 ADV POS 1", orth: "e", senses: ["-ily; -ly;"] },
    {
      pos: "V",
      form: "V 1 ADJ 0 0 SUPER 0",
      orth: "antissi",
      senses: [
    ...
    {
      pos: "A",
      form: "ADJ 2 ADJ 0 0 SUPER 4",
      orth: "issi",
      senses: ["-est, most ~, much ~, makes SUPER;"]
    },
    {
      pos: "V",
      form: "V   4 ADJ 0 0 SUPER 4",
      orth: "issi",
      senses: [
        "makes a verb PERF PPL into an adjective SUPER (amat.issimus => most/much loved);"
      ]
    },
    { pos: "N", form: "N 2 ADJ 1 1 POS 0", orth: "boni", senses: ["of good;"] },
    {
      pos: "V",
      form: "V 2 N 1 1 F t 0",
      orth: "moni",
      senses: ["-monia; act of; means of; result of;"]
    },
    {
      pos: "V",
      form: "V 2 N 2 2 N t 0",
      orth: "moni",
      senses: ["-monia; act of; means of; result of;"]
    },
    {
      pos: "V",
      form: "V 1 N 1 1 F t 0",
      orth: "anti",
      senses: ["-ance; state of; quality of; act of; (with 1st conj verbs);"]
    },
    {
      pos: "V",
      form: "V 1 ADJ 0 0 COMP 0",
      orth: "anti         --  Conflicts with another -anti-",
      senses: ["more -ing, makes ADJ COMP of verb, ('a' stem is for V 1 0);"]
    },
    {
      pos: "V",
      form: "V 1 N 1 1 F t 0",
    ...
    },
    {
      ...
      form: "V 1 ADJ 0 0 COMP 0",
      orth: "enti",
      senses: ["more -ing, makes ADJ COMP of verb, ('e' stem is for V 2/3);"]
    },
    {
      pos: "N",
      form: "N 2 N 1 1 F t  0",
      orth: "ari",
      senses: [
    ...
    {
      pos: "N",
      form: "N 2 N 2 2 N t  0",
      orth: "ari",
      senses: ["-arium, -ary; place where;"]
    },
    {
      pos: "N",
      form: "N 2 N 2 1 M p  0",
      orth: "ari",
      senses: [
    ...
    },
    {
      ...
      form: "N 2 N 2 2 N t  0",
      orth: "ori",
      senses: ["-orium, -ory, -or; place where;"]
    },
    {
      pos: "V",
      form: "V 4 ADJ 1 1 POS 0",
      orth: "ori",
      senses: ["-orous, -ory; having to do with, pretaining to; tending to;"]
    },
    {
      pos: "A",
      form: "ADJ 2 N 1 1 F t  0",
      orth: "iti",
      senses: [
    ...
    },
    {
      ...
      form: "ADJ 2 ADJ 0 0 SUPER 4",
      orth: "li  l",
      senses: ["-est, most ~, much ~, makes ADJ with stem ending in 'l' SUPER;"]
    },
    {
      pos: "A",
      form: "ADJ 1 ADJ 0 0 SUPER 4",
      orth: "ri  r",
      senses: ["-est, most ~, much ~, makes ADJ with stem ending in 'r' SUPER;"]
    },
    {
      pos: "A",
      form: "ADJ 2 N 1 1 F t  0",
    ...
    {
      pos: "A",
      form: "ADJ 2 ADJ 0 0 COMP 3",
      orth: "i",
      senses: ["-er, makes adjective comparative;"]
    },
    {
      pos: "V",
      form: "V   4 ADJ 0 0 COMP 3",
      orth: "i",
      senses: [
    ...
    {
      pos: "X",
      form: "X 2 ADJ 3 2 POS  0",
      orth: "abil",
      senses: ["-able, -ble; having the passive quality, able to, able to be;"]
    },
    {
      pos: "N",
      form: "N 2 ADJ 3 2 POS 0",
      orth: "atil",
      senses: ["-il; of a, pertaining to a, in a condition of, in a state of;"]
    },
    {
      pos: "V",
      form: "V 2 ADJ 3 2 POS  0",
      orth: "ibil",
      senses: [
    ...
    {
      pos: "X",
      form: "X 2 N 1 1 F t 0",
      orth: "bul",
      senses: ["forms noun of means, instrument; place;"]
    },
    {
      pos: "X",
      form: "X 2 N 2 2 N t 0",
      orth: "bul",
      senses: ["forms noun of means, instrument; place;"]
    },
    {
      pos: "N",
      form: "N 2 N 1 1 M p 0",
      orth: "col",
      senses: ["denotes one who inhabits/tills/worships;"]
    },
    {
      pos: "V",
      form: "V 2 N 2 2 N t 0",
    ...
    },
    {
      ...
      form: "X 2 ADV POS 1",
      orth: "atim",
      senses: ["_ by _; eg. step by step; little by little;"]
    },
    {
      pos: "X",
      form: "X 2 ADV POS 1",
      orth: "itim",
      senses: ["_ by _; eg. vir.itim => man by man;"]
    },
    {
      pos: "N",
      form: "N 2 ADJ 1 1 POS 0",
    ...
    {
      pos: "A",
      form: "ADJ 2 N 3 1 F t  2",
      orth: "udin  t",
      senses: ["-ness; makes abstract noun;"]
    },
    {
      pos: "V",
      form: "V 4 N 3 1 F t  2",
      orth: "sion",
      senses: [
    ...
    },
    {
      ...
      form: "N 2 N 2 1 M p 0",
      orth: "ian",
      senses: ["of/belonging to  [N -> ADJ] (Cicero -> Ciceronianus);"]
    },
    {
      pos: "V",
      form: "V 2 N 3 2 N t 1",
      orth: "men",
      senses: ["act of; means of; result of;"]
    },
    {
      pos: "N",
      form: "NUM 3 NUM 1 4 DIST 0 3",
      orth: "ten",
      senses: [
    ...
    {
      pos: "V",
      form: "V 2 N 3 2 N t 2",
      orth: "min",
      senses: ["act of; means of; result of;"]
    },
    {
      pos: "V",
      form: "V 2 N 3 1 F t  1",
      orth: "don",
      senses: ["act of or result of the action of the verb;"]
    },
    {
      pos: "V",
      form: "V 2 N 3 1 F t  1",
    ...
    {
      pos: "N",
      form: "NUM 2 N 2 1 M p 0",
      orth: "an",
      senses: ["soldiers of the Nth Legion;"]
    },
    {
      pos: "A",
      form: "ADJ 2 ADJ 1 1 POS 0",
      orth: "an",
      senses: [
    ...
    { pos: "V", form: "V 2 ADV POS 1", orth: "abiliter", senses: ["-abaly;"] },
    { pos: "V", form: "V 2 ADV POS 1", orth: "ibiliter", senses: ["-ibaly;"] },
    {
      pos: "N",
      form: "N 2 ADV POS 1",
      orth: "aliter",
    ...
    { pos: "V", form: "V 1 ADV POS 1", orth: "anter", senses: ["-ingly;"] },
    { pos: "V", form: "V 1 ADV POS 1", orth: "enter", senses: ["-ingly;"] },
    {
      pos: "N",
      form: "N 2 ADJ 1 1 POS 1",
      orth: "ester",
      senses: [
        "-urnal, -ily, -y, -ing; of, belonging to  (esp. of place and time);"
      ]
    ...
    {
      pos: "N",
      form: "N 2 ADJ 1 1 POS 2",
      orth: "estr",
      senses: ["-y; of the, of, belonging to  (esp. of place and time);"]
    },
    { pos: "A", form: "ADJ 2 ADV POS 1", orth: "iter", senses: ["-ily; -ly;"] },
    {
      pos: "A",
      form: "ADJ 2 ADJ 0 0 COMP  3",
      orth: "ior",
      senses: ["-er, more ~; makes ADJ POS into ADJ COMP;"]
    },
    {
      pos: "N",
      form: "N 2 N 3 1 M P 0",
      orth: "por",
      senses: [
    ...
    },
    {
      ...
      form: "N 2 ADJ 3 2 POS 0",
      orth: "ar",
      senses: ["-ary; of a, pertaining to a; (-like?);"]
    },
    {
      pos: "V",
      form: "V 2 N 2 2 N t 0",
      orth: "br",
      senses: ["denotes means or instrument;"]
    },
    {
      pos: "V",
      form: "V 2 N 2 2 N t 0",
    ...
    { pos: "A", form: "ADJ 2 ADV POS 1", orth: "er  t", senses: ["-ly;"] },
    {
      pos: "V",
      form: "V 4 N 3 1 M p  0",
      orth: "or",
      senses: [
    ...
    },
    {
      ...
      form: "V 2 N 2 2 N t 0",
      orth: "tr",
      senses: ["means, instrument; place;"]
    },
    {
      pos: "N",
      form: "N 2 N 1 1 F t  0",
      orth: "ur",
      senses: ["-ure, pertaining to, use of;"]
    },
    {
      pos: "N",
      form: "N 4 N 1 1 F t  0",
      orth: "ur",
      senses: ["-ure, pertaining to, use of;"]
    },
    {
    ...
    },
    {
      ...
      form: "X 2 ADV POS 1",
      orth: "itus",
      senses: ["of _; from the _; -ing;"]
    },
    {
      pos: "N",
      form: "N 2 N 3 1 F t  1",
      orth: "tas",
      senses: ["-ness, condition of being; makes abstract noun;"]
    },
    {
      pos: "N",
      form: "N 2 N 3 1 F t  1",
      orth: "tus",
      senses: ["-liness, makes abstract noun;"]
    },
    {
      pos: "V",
      form: "V 1 ADJ 3 1 POS  1",
      orth: "ans",
      senses: [
    ...
    {
      pos: "N",
      form: "N 2 N 1 1 F p 0",
      orth: "iss",
      senses: ["female (whatever the noun base was);"]
    },
    {
      pos: "A",
      form: "ADJ 2 ADV COMP 0",
      orth: "ius",
      senses: ["more -ly; -ier;"]
    },
    {
      ...
      form: "X 2 ADV POS 1",
      orth: "tus",
      senses: ["of _; from the _;"]
    },
    {
      pos: "N",
      form: "N 2 N 3 1 F t 1",
      orth: "es",
      senses: ["result of; place of; (abstract noun);"]
    },
    {
      pos: "N",
      form: "N 2 N 3 1 F t 2",
      orth: "is",
      senses: ["result of; place of; (abstract noun);"]
    },
    {
      ...
      form: "N 2 ADJ 1 1 POS 0",
      orth: "os",
      senses: ["-ous, -ose; -some, full of; prone to; rich in; abounding in;"]
    },
    { pos: "A", form: "ADJ 2 ADV POS  1", orth: "us", senses: ["-ly;"] },
    {
      pos: "A",
      form: "ADJ 3 ADV COMP 0",
      orth: "us",
      senses: ["more -ly; -lier;"]
    },
    {
      ...
      form: "N 2 ADJ 1 1 POS 0",
      orth: "olent",
      senses: ["-olent; full of; prone to; rich in; abounding in;"]
    },
    {
      pos: "N",
      form: "N 2 ADJ 1 1 POS 0",
      orth: "ulent",
      senses: ["-ulent; full of; prone to; rich in; abounding in;"]
    },
    {
      pos: "V",
      form: "V 2 N 2 2 N t 0",
    ...
    },
    {
      ...
      form: "N 2 ADJ 1 1 POS 0",
      orth: "at",
      senses: ["-ed, having, having a, provided with; -able;"]
    },
    {
      pos: "N",
      form: "N 2 ADJ 1 1 POS 0",
    ...
    },
    {
      ...
      form: "N 2 ADJ 1 1 POS 0",
      orth: "ativ",
      senses: ["-ative; capable/worthy of;"]
    },
    {
      pos: "V",
      form: "V 2 V 1 1 X 3",
    ...
    },
    {
      ...
      form: "V 2 ADJ 1 1 POS 0",
      orth: "iv",
      senses: ["-ive, -ed; tending to, pretaining to;"]
    },
    {
      pos: "V",
      form: "V 4 ADJ 1 1 POS 0",
      orth: "iv",
      senses: ["-ive, -ed; having the passive tendency; having been ...-ed;"]
    },
    {
      pos: "N",
      form: "N 2 N 3 1 M P   1",
      orth: "ifex",
      senses: [
        "denotes one who makes (the source noun), master of, professional in;"
      ]
    ...
    {
      pos: "X",
      form: "X 2 ADJ 3 1 POS 1",
      orth: "ax",
      senses: ["-ing; having a tendency/ability;"]
    }
  ],
